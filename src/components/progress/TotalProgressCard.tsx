...
export const TotalProgressCard = ({
  ...
  return (
    <Card className="p-6 col-span-1 shadow-md hover:shadow-xl transition-all duration-300 shadow-[0_0_15px_rgba(155,135,245,0.2)] border-0">
      <h3 className="text-lg font-semibold mb-6 text-center">Total Progress</h3>
