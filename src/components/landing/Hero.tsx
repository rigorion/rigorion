  ...
  return (
    <section className="relative bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 py-32 overflow-hidden">
      <div className="absolute inset-0">
        <img 
          src="/lovable-uploads/cd57f5b5-61c8-44ec-a6f5-22d2a8296a14.png" 
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center justify-center text-center">
          <h1 className="font-cursive text-5xl md:text-7xl text-white mb-4">
            Personality Arc
          </h1>
          ...
          <Button 
            className="bg-[#8A0303] hover:bg-[#6a0202] text-white font-medium px-8 py-6 rounded-md text-lg h-auto"
          >
            Take it Now
          </Button>
        </div>
