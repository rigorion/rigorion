  ...
  return <Card className="overflow-hidden bg-white rounded-xl transition-all duration-300 hover:shadow-md border border-gray-100">
      <div className="relative">
        ...
        <div className="p-6">
          ...
          {module.status === "available" && <button onClick={handleClick} className="text-m px-4 py-1 r-5 rounded-full border border-green-600 text-green-600 bg-white hover:bg-green-500 text-white transition-all duration-300 glow-button border-green-500">
              Join Now
            </button>}
        </div>
      </div>
